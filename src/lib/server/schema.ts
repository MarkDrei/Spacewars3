...
CREATE TABLE IF NOT EXISTS users (
  ...
  defense_last_regen BIGINT NOT NULL DEFAULT 0,

  -- Build queue
  build_queue TEXT DEFAULT NULL,
  build_start_sec BIGINT DEFAULT NULL,
...
// PostgreSQL doesn't support these specific migration patterns
// For PostgreSQL, we'll use a fresh database approach as mentioned in requirements
// Migrations are not needed when starting fresh
