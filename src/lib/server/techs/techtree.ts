...
/**
 * Calculate the damage modifier for a weapon type based on research levels.
 * 
 * This function determines whether the weapon is projectile or energy-based,
 * then reads the corresponding damage research (ProjectileDamage or EnergyDamage)
 * to calculate a multiplier relative to the base damage.
 * 
